...
namespace HttpMock
{
    ...
    {
        IRequestHandler Match(Kayak.Http.HttpRequestHead request, IEnumerable<IRequestHandler> requestHandlerList);
    }
    ...
    public class RequestMatcher : IRequestMatcher
    {
        ...
        public IRequestHandler Match(Kayak.Http.HttpRequestHead request, IEnumerable<IRequestHandler> requestHandlerList)
        {
